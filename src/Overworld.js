class Overworld extends Phaser.Scene {
    ...
    create() {
        ...
        const bgLayer2 = map.createLayer('Tile Layer 2', tileset, 0,0);
        const bgLayer3 = map.createLayer('Tile Layer 3', tileset, 0,0);

        //collisions
        bgLayer2.setCollisionByProperty({
            collides: true
        })
        ...
        this.physics.add.collider(this.slime, bgLayer2)
